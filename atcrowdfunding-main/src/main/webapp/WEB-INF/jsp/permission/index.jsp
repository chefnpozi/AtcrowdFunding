	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel">添加权限(✿◡‿◡)</h4>
	      </div>
	...
	<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="myModalLabel">修改权限(✿◡‿◡)</h4>
	      </div>
	      <div class="modal-body">
    ...
    <%@ include file="/WEB-INF/jsp/common/js.jsp" %>
        ...
        <script type="text/javascript">
            ...
            $('#saveBtn').click(function(){
            	...
            	// 将拿到的数据传给后端，存储在数据库
            	$.post("${PATH}/permission/doAdd",json,function(result){
            ...
            function deleteBtn(id){
            	// 给个询问框
            	layer.confirm("您确定要删除这个权限吗？o(╥﹏╥)o",{btn:["确定","取消"]},function(index){
            		// 确认要删除
            ...
            function updateBtn(id){
            	...
            	$('#updateBtn').click(function(){
            		...
            		// 修改
            		$.post("${PATH}/permission/doUpdate",data,function(result){
                		// 返回 ok 表示修改成功
                		if(result=="ok"){
